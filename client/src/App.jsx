  ...
  return (
    <Container maxWidth="lg">
      <AppBar className={styleClass.appBar} position='static' color='inherit' >
        <Typography className={styleClass.heading} variant='h2' align='center' > Anılarım
      ...
      <Grow in>
        <Container >
          <Grid container justifyContent='space-between' alignItems='stretch' spacing={3} >
            <Grid className={styleClass.posts} item xs={12} sm={7}>
              <Posts setCurrentId={setCurrentId} />
            </Grid>
            <Grid item xs={12} sm={4} className={styleClass.form} >
